...
The Objective function is the weight, assumed to be inversely proportional to the stress allowable  _W = W\1/S1+W2/S2_, where _S1_ and _S2_ are the allowables (failure strength of the material for each panel).
